      ...
      <div class="card card-small country-stats">
        ...
        <div class="card-body p-0">
          ...
          <table class="table m-0">
            <tbody>
              <tr>
                <td><img class="country-flag mr-1" src="plantilla/basica/images/flags/flag-us.png" alt="United States"> United States</td>
                <td class="text-right">12,219</td>
                <td class="text-right">32.4%</td>
              </tr>
              <tr>
                <td><img class="country-flag mr-1" src="plantilla/basica/images/flags/flag-uk.png" alt="United Kingdom"> United Kingdom</td>
                <td class="text-right">11,192</td>
                <td class="text-right">18.8%</td>
              </tr>
              <tr>
                <td><img class="country-flag mr-1" src="plantilla/basica/images/flags/flag-au.png" alt="Australia"> Australia</td>
                <td class="text-right">9,291</td>
                <td class="text-right">12.3%</td>
              </tr>
              <tr>
                <td><img class="country-flag mr-1" src="plantilla/basica/images/flags/flag-jp.png" alt="Japan"> Japan</td>
