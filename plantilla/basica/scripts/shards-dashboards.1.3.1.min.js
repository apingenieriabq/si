! function(e, t) {
    ...
    $(document).ready(function() {
        ...
        $(".dropdown.menu-lateral").on("show.bs.dropdown", function() {
            $(this).find(".dropdown-menu").slideDown();
            $(this).find(".dropdown-menu").addClass('menu-abierto');
        }),

        $(".dropdown.menu-lateral").on("hide.bs.dropdown", function() {
            // if($(this).find(".dropdown-menu").hasClass('menu-abierto')){
                $(this).find(".menu-abierto").slideUp();
            // }
        }),
